...
<head>
	...
	<script type="text/javascript" src="require/js/listFaq.js"></script>
...
<body>
	...
	<div class="container">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<img src="images/logo-faq.jpg" whidt>
				<form class="navbar-form navbar-right" role="search"
					action="javascript:void(0)">
					<div class="form-group">
						<input type="text" id="eLogin" class="form-control"	placeholder="Email"> 
							<input type="password" id="sLogin" class="form-control" placeholder="Senha">


						<button onclick="fctLogin()" class="btn btn-default">Entrar</button>
